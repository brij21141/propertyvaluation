...
class EngineerReport(models.Model):
    ...
    east = models.CharField(max_length=50,null=True,blank=True)
    west = models.CharField(max_length=50,null=True,blank=True)
    north = models.CharField(max_length=50,null=True,blank=True)
    south = models.CharField(max_length=50,null=True,blank=True)
    barea = models.CharField(max_length=10,null=True,blank=True)
    gfarea = models.CharField(max_length=10,null=True,blank=True)
    ffarea = models.CharField(max_length=10,null=True,blank=True)
    sfarea = models.CharField(max_length=10,null=True,blank=True)
    tfarea = models.CharField(max_length=10,null=True,blank=True)
    frarea = models.CharField(max_length=10,null=True,blank=True)
    fvarea = models.CharField(max_length=10,null=True,blank=True)
    sxarea = models.CharField(max_length=10,null=True,blank=True)
    propertyage = models.CharField(max_length=3,null=True,blank=True)
    landrate = models.CharField(max_length=10,null=True,blank=True)    
    occupant = models.CharField(max_length=50,null=True,blank=True)
    rented = models.CharField(max_length=50, null=True,blank=True)
    landmark = models.CharField(max_length=100,null=True,blank=True)
    roadwidth = models.CharField(max_length=10,null=True,blank=True)
    hightensionline = models.BooleanField(null=True,blank=True)
    railwayline = models.BooleanField(null=True,blank=True)
    nala = models.BooleanField(null=True,blank=True)
    river = models.BooleanField(null=True,blank=True)
    pahad = models.BooleanField(null=True,blank=True)
    roadcomesunderroadbinding = models.BooleanField(null=True,blank=True)
    propertyaccessissue = models.BooleanField(null=True,blank=True)
    othercheck = models.BooleanField(null=True,blank=True)
    others = models.CharField(max_length=100, null=True, blank=True)
    remark = models.CharField(max_length=100, null=True, blank=True)
    reporter = models.CharField(max_length=10, null=True,blank=True)
